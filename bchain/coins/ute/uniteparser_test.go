...
func TestParseOpReturn(t *testing.T) {
	...
	op_ret_addr := ute.TryParseOPReturn(opReturnHexBytes)
	if op_ret_addr != "OP_RETURN" {
		t.Errorf("OpRetAddr is incorrect %s", op_ret_addr)
		return
	}
	...
	op_ret_addr = ute.TryParseOPReturn(opReturnHexBytes)
	if op_ret_addr != "OP_RETURN aa21a9ed941b41ad0b6a2c6b93d98dd32ff22ae87dcf3b95b721102f5956b9d7a3d299f2" {
		t.Errorf("OpRetAddr is incorrect %s", op_ret_addr)
		return
	}
